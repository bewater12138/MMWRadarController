...
static bool glfw_init()
{
	...
	GLFWwindow* window = glfwCreateWindow((int)(1280 * main_scale), (int)(800 * main_scale), "MMWRadarController", nullptr, nullptr);
	if (window == nullptr)
		return false;
	g_Window = window;
...
static bool imgui_init()
{
    ...
    ImGui::StyleColorsLight();
    {
        ...
        colors[ImGuiCol_PopupBg] = ImVec4(0.13f, 0.13f, 0.13f, 0.88f);
        ...
        colors[ImGuiCol_Separator] = ImVec4(0.41f, 0.41f, 0.41f, 0.62f);
        ...
        colors[ImGuiCol_ResizeGripActive] = ImVec4(0.29f, 0.29f, 0.29f, 0.95f);
        colors[ImGuiCol_TabHovered] = ImVec4(0.27f, 0.27f, 0.27f, 1.00f);
        colors[ImGuiCol_Tab] = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
        colors[ImGuiCol_TabSelected] = ImVec4(0.26f, 0.26f, 0.26f, 1.00f);
        ...
        colors[ImGuiCol_DockingPreview] = ImVec4(0.13f, 0.54f, 0.56f, 0.71f);
        ...
        colors[ImGuiCol_TextLink] = ImVec4(0.44f, 0.44f, 0.44f, 1.00f);
    ...
    ImGui::GetStyle().WindowBorderSize = 3.0f;
    ...
    io.Fonts->AddFontFromFileTTF("fonts/jianti.ttf", font_size, nullptr, io.Fonts->GetGlyphRangesChineseFull());
    return true;
}
